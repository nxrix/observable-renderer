...
```html
<script type="module" src="https://cdn.jsdelivr.net/gh/nxrix/observable-renderer@1.1.3/src/loader.js"></script>
```

### Renderer

```js
import { render, split } from "https://cdn.jsdelivr.net/gh/nxrix/observable-renderer@1.1.3/src/renderer.js";
...
```js
import { split } from "https://cdn.jsdelivr.net/gh/nxrix/observable-renderer@1.1.3/src/renderer.js";
